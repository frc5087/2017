 ...
 */
public class RamsRobotDrive implements MotorSafety {
...
//  @SuppressWarnings("MemberName")
   ...
   */
  public RamsRobotDrive(final int leftMotorChannel, final int rightMotorChannel) {
   ...
   */
  public RamsRobotDrive(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
   ...
   */
  public RamsRobotDrive(SpeedController leftMotor, SpeedController rightMotor) {
   ...
   */
  public RamsRobotDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
